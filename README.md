...
| **Fuccina Suite: [Egida](https://github.com/SantiagoDaleffe/Egida) & [Slancio](https://github.com/SantiagoDaleffe/Slancio)** | Decoupled, serverless push-model ecosystem for B2B SaaS (FinTech & E-commerce). Features asynchronous scheduling via Upstash QStash, ACID-compliant idempotency locks for Stripe/Shopify webhooks, and infrastructure provisioned entirely via Terraform.
